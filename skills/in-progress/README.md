...
- **[design-harness](./design-harness/SKILL.md)**: Set up a project's frontend design stack: design tool, whether agents read DESIGN.md, and whether open briefs use the frontend-design skill. User-invoked.
