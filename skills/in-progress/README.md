...
- **[coding-harness](./coding-harness/SKILL.md)**: Set up a project's coding harness: six blocks, git strategy, how a request enters, and four gates that must be shown before a task is called done. User-invoked.
